...
function initBt11() {
    ...
    var bt1c=document.querySelector('.button__container11');
    var $circlesTopLeft=bt1.querySelectorAll('.circle11.top-left11');
    var $circlesBottomRight=bt1.querySelectorAll('.circle11.bottom-right11');
    ...
    tlBt2.add(tl2);
    btTl.add(tlBt1);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg11'), 0.8, {
        scaleY: 1.1
    }
    , 0.1);
    btTl.add(tlBt2, 0.2);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg11'), 1.8, {
        scale: 1, ease: Elastic.easeOut.config(1.2, 0.4)
    }
    , 1.2);
    btTl.timeScale(2.6);
...
function initBt12() {
    var bt1=document.querySelectorAll('#component-12')[0];
    var bt1c=document.querySelector('.button__container12');
    var $circlesTopLeft=bt1.querySelectorAll('.circle12.top-left12');
    var $circlesBottomRight=bt1.querySelectorAll('.circle12.bottom-right12');
    var filter=document.querySelectorAll('#filter-goo-12 feGaussianBlur')[0];
    var tl=new TimelineLite();
    var tl2=new TimelineLite();
    var btTl=new TimelineLite( {
        paused: true, onUpdate: function() {
    ...
    tlBt2.add(tl2);
    btTl.add(tlBt1);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg12'), 0.8, {
        scaleY: 1.1
    }
    , 0.1);
    btTl.add(tlBt2, 0.2);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg12'), 1.8, {
        scale: 1, ease: Elastic.easeOut.config(1.2, 0.4)
    }
    , 1.2);
    btTl.timeScale(2.6);
...
function initBt13() {
    var bt1=document.querySelectorAll('#component-13')[0];
    var bt1c=document.querySelector('.button__container13');
    var $circlesTopLeft=bt1.querySelectorAll('.circle13.top-left13');
    var $circlesBottomRight=bt1.querySelectorAll('.circle13.bottom-right13');
    var filter=document.querySelectorAll('#filter-goo-13 feGaussianBlur')[0];
    var tl=new TimelineLite();
    var tl2=new TimelineLite();
    var btTl=new TimelineLite( {
        paused: true, onUpdate: function() {
    ...
    tlBt2.add(tl2);
    btTl.add(tlBt1);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg13'), 0.8, {
        scaleY: 1.1
    }
    , 0.1);
    btTl.add(tlBt2, 0.2);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg13'), 1.8, {
        scale: 1, ease: Elastic.easeOut.config(1.2, 0.4)
    }
    , 1.2);
    btTl.timeScale(2.6);
...
function initBt14() {
    var bt1=document.querySelectorAll('#component-14')[0];
    var bt1c=document.querySelector('.button__container14');
    var $circlesTopLeft=bt1.querySelectorAll('.circle14.top-left14');
    var $circlesBottomRight=bt1.querySelectorAll('.circle14.bottom-right14');
    var filter=document.querySelectorAll('#filter-goo-14 feGaussianBlur')[0];
    var tl=new TimelineLite();
    var tl2=new TimelineLite();
    var btTl=new TimelineLite( {
        paused: true, onUpdate: function() {
    ...
    tlBt2.add(tl2);
    btTl.add(tlBt1);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg14'), 0.8, {
        scaleY: 1.1
    }
    , 0.1);
    btTl.add(tlBt2, 0.2);
    btTl.to(bt1.parentNode.querySelectorAll('.button__bg14'), 1.8, {
        scale: 1, ease: Elastic.easeOut.config(1.2, 0.4)
    }
    , 1.2);
    btTl.timeScale(2.6);
